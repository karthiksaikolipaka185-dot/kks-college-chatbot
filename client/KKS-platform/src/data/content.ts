...
export const aboutContent = {
  title: "About KKS University",
  subtitle: "Empowering Futures Since 2005",
  description:
    "KKS University is a premier engineering and technology institution established in 2005, located in Hyderabad, Telangana. Affiliated with JNTU Hyderabad and approved by AICTE, New Delhi, our 25-acre campus features smart classrooms, advanced laboratories, and a central library with 50,000+ books.",
  highlights: [
...
export const mentorsContent = [
  {
    name: "Prof. Parimal Vijay Mandke",
  ...
  {
    name: "Dr. Ganapathi Rao Maradana",
